...
CMatrix::CMatrix()
	: position(0, 0), center(0, 0), scale(1, 1), animation(false), aniTimer(0), aniTime(0), currentScene(0), maxScene(0), repeatAni(false), isAniEnd(false), rotate(0)
{
...
void CMatrix::SetAnimation(float rate, int maxScene, bool repeatAni)
{
	animation = true;
