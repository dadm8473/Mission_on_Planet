...
void CAssetManager::LoadAssets()
{
	// LoadTexutre("key", L"filename", L"png", maxScene);

	LoadTexture("Player", L"images/Player/Player1/player001", L"png", 20);
...
void CAssetManager::ReleaseAssets()
{
...
void CAssetManager::LoadTexture(string key, LPCWSTR filename, LPCWSTR extname, int maxScene)
{
...
CTexture * CAssetManager::GetTexture(string key)
{
	if (textures.find(key) == textures.end())
		return NULL;
	return textures[key];
