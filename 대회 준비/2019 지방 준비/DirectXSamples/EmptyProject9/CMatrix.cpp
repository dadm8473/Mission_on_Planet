...
CMatrix::CMatrix()
	:position(0,0), scale(1,1), center(0,0), rotate(0), animation(false),
	aniTimer(0), aniTime(0), currentScene(0), maxScene(0), repeatAni(false), isAniEnd(false)
{
...
void CMatrix::Draw(LPD3DXSPRITE sprite, CTexture * texture)
{
	...
	sprite->Draw(texture->GetTexture(currentScene), NULL, NULL, NULL,
