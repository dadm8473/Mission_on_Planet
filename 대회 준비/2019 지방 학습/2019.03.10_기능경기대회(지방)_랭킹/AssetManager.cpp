...
void CAssetManager::InitAssets()
{
	...
	alphabetTexture = new CTexture(L"Images/UI/alphabet/apb_", L"png", 26);
	rankingBackgroundTexture = new CTexture(L"Images/Main/RankingBackground", L"png", 1);
}
...
void CAssetManager::TermAssets()
{
	...
	delete alphabetTexture;
	delete rankingBackgroundTexture;
}